  ...
  return (
    <>
      ...
      <div className="textarea flex items-center justify-center flex-col mt-[10px]">
        ...
        <button onClick={generateRes} className="gen p-[10px] bg-purple-600 text-white rounded-[10px] mt-[20px] min-w-[200px] trsnsition-all duration-300 hover:bg-purple-700">Generate</button>
      </div>
